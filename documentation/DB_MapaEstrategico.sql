...
CREATE TABLE IF NOT EXISTS `INDICADORES` (
  ...
  `DESCRICAO_IND` VARCHAR(100) NULL,
  `OBJETIVOS_idOBJETIVO` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `METAS` (
  ...
  `VERMELHO_INI` FLOAT NULL,
  `VERMELHO_LIM` FLOAT NULL,
  `AMARELO_INI` FLOAT NULL,
...
CREATE TABLE IF NOT EXISTS `IMPORTACOES` (
  ...
  INDEX `fk_IMPORTACOES_ITENS1_idx` (`ITENS_idITEM` ASC),
  INDEX `fk_IMPORTACOES_INDICADORES1_idx` (`INDICADORES_idINDICADOR` ASC),
  CONSTRAINT `fk_IMPORTACOES_ITENS1`
...
CREATE TABLE IF NOT EXISTS `ITENS_has_PERSPECTIVAS` (
  `ITENS_idITEM` INT NOT NULL,
  `PERSPECTIVAS_idPERSPECTIVA` INT NOT NULL,
  PRIMARY KEY (`ITENS_idITEM`, `PERSPECTIVAS_idPERSPECTIVA`),
  INDEX `fk_ITENS_has_PERSPECTIVAS_PERSPECTIVAS1_idx` (`PERSPECTIVAS_idPERSPECTIVA` ASC),
  INDEX `fk_ITENS_has_PERSPECTIVAS_ITENS1_idx` (`ITENS_idITEM` ASC),
  CONSTRAINT `fk_ITENS_has_PERSPECTIVAS_ITENS1`
    FOREIGN KEY (`ITENS_idITEM`)
    REFERENCES `ITENS` (`idITEM`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ITENS_has_PERSPECTIVAS_PERSPECTIVAS1`
    FOREIGN KEY (`PERSPECTIVAS_idPERSPECTIVA`)
    REFERENCES `PERSPECTIVAS` (`idPERSPECTIVA`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
